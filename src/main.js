  ...
  return (
    `<section class="main__filter filter container">
      ...
      <label for="filter__all" class="filter__label">
        All <span class="filter__all-count">3</span></label
      >
      <input
        type="radio"
        id="filter__overdue"
      ...
      >Today <span class="filter__today-count">3</span></label
      >
      <input
        type="radio"
...
const createTaskEditTemplate = () => {
  return (
    `<article class="card card--edit card--green card--repeat">
              ...
              <div class="card__dates">
                <div class="card__date-deadline">
                  <p class="card__input-deadline-wrap">
                    <span class="card__date">29 July</span>
                  </p>
                </div>
              </div>
            </div>
